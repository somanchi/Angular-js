...
if (isset($_POST['update'])){
	  ...
	  $amount = $_POST['amount'];
		$sql = "INSERT INTO `loans_types` (`Loanname`, `Range_of_amount`) VALUES ('$loantype', '$amount'); ; ";
...
<table border='5'>
				...
				<td><a href="delete8.php?did=<?php echo $row['Loanname']?>">
